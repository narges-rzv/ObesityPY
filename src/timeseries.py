...
def construct_temporal_data(xtrain, headers, ytrain, ylabels, mux=None, stdx=None, subset=np.array([False, False, False, False, False, True, False, False, True, False, False, False, False, False, False])):
    # print(xtrain.shape)
